...
export default function ForgotPassword() {
    ...
    return (
        <div className="flex justify-center min-h-[80vh] items-center p-4">
                    ...
                    !otpId
                        ? (
                            <form className="  px-5 md:px-12 py-10 grid gap-8 mx-5 md:mx-0" onSubmit={handleSendEmail}>
                                ...
                                <button
                                    disabled={loading}
                                    className="bg-blue-600 px-8 py-3 text-white rounded-md font-semibold text-sm cursor-pointer"
                                >
                                    {
